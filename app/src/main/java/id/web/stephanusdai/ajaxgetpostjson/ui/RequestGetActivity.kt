...
class RequestGetActivity : AppCompatActivity(), AjaxRequestUtil.OnResponseListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            ajaxRequestUtil.open("/wiefunkdai/AndroidAjaxGetPostRequest/master/app/src/main/assets/sampledata.json")
        } catch (e: Exception) {
            e.printStackTrace()
        }
    }
                ...
                if (error == null && response != null) {
                    withContext(Dispatchers.Main) {
                        ...
                        with(binding.resultsPhoto) {
                            try {
                                val imagePhoto =
                                    ajaxRequestUtil.getBitmapFromUrl(response.getString("photo"))
                        ...
                        binding.buttonList.setOnClickListener({
                            try {
                                ...
                                for (i in 0 until jsonArray.length()) {
                                    ...
                                    val employee =
                                        jsonArray.getJSONObject(i).getJSONObject("employee")
